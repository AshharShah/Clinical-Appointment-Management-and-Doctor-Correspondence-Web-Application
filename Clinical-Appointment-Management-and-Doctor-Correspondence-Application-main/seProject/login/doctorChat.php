...
<div class="container">		
		...
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					...
					$valuee = $_SESSION['userid'];
        //echo "<script>alert('$valuee');</script>";
					...
					foreach ($chatUsers as $user) {
						...
						$valuser = $user['userid'];
						$appointquery = "SELECT patientid FROM appointment1 WHERE patientid = $valuser AND doctorid = $valuee";
						...
						$result = $conn->query($appointquery);
	...
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="doctorDashboard.php">Back to Dashboard</a>		
	</div>	
</div>	
